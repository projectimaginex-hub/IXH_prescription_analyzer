...
class Patient(models.Model):
    ...
    # # Field store all pdf of previous medication from this doctor
    # medication_pdf = models.FileField(
    #     upload_to='medication_pdfs/', blank=True, null=True)
...
class Doctor(models.Model):
    ...
    clinic_name = models.CharField(
        max_length=255, blank=True, null=True, help_text="Official name of the clinic/practice.")
    clinic_address = models.CharField(max_length=255, blank=True, null=True,
                                      help_text="Address, Phone, Email (Pipe-separated if using the default form).")
    clinic_logo = models.ImageField(upload_to='clinic_logos/', blank=True,
                                    null=True, help_text="Logo for the prescription watermark.")
...
class LLMAudit(models.Model):
    ...
    # e.g., 'symptom_extraction', 'medicine_prediction'
