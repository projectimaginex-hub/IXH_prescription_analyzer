...
# We will define this helper function
from .llm_utils import analyze_transcription_text
...
def transcribe_audio_view(request):
    ...
    transcribed_text = get_transcription_from_service(
        audio_instance.audio_file.path)
...
def analyze_prescription_view(request):
    ...
    try:
        ...
        suggested_medicines = [
            {'name': 'Paracetamol', 'reason': 'To reduce fever and pain.',
                'confidence': 0.92},
